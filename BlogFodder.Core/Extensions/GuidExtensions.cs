...
public static class GuidExtensions
{
    ...
    public static Guid NewSequentialGuid(this Guid guid)
    {
        // Fill the destination array with a guid - only the last 6 bytes of a guid are
            ...
            var destinationArray = guid.ToByteArray();
            ...
            var bytesFromMilliseconds =
                BitConverter.GetBytes((long) (timeOfDay.TotalMilliseconds /
                                              3.333333)); // Note that SQL Server is accurate to 3.33 millisecond so we divide by 3.333333,
            ...
            Array.Copy(bytesFromClockTicks, bytesFromClockTicks.Length - 2, destinationArray,
                destinationArray.Length - 6, 2);
            Array.Copy(bytesFromMilliseconds, bytesFromMilliseconds.Length - 4, destinationArray,
